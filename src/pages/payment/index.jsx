...
function PaymentPage() {
    ...
    const [bill, setBill] = useState(JSON.parse(query.yourBill).grandTotal)
    ...
    return (
        <div className='h-2/4'>
            {!spinners ? (
                        ...
                        <form id="paymentForm" className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="flex space-x-4">
                                <div className="flex-1">
                                    ...
                                    <input type="date" min={selectedDate} {...register("expirationDate", { required: true })} id="expirationDate" className="mt-1 block w-full border-gray-500 rounded-md shadow-md focus:ring focus:ring-opacity-50 focus:ring-blue-400 focus:border-blue-400 sm:text-sm" />
                                </div>
                                <div className="flex-1">
                ...
                <div className="container bg-green-200 p-8 h-3/4 rounded-lg shadow-lg">
                ...
                <div className="flex justify-center  gap-2 items-center h-3/4 bg-blue-500">
